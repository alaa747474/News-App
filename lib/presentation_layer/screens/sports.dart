...
import 'package:news_app/presentation_layer/widgets/sports_item.dart';
...
class _SportsState extends State<Sports> {
  ...
  void addToSearchedList(String value) {
    setState(() {
      searchedItems = sportsNews
  ...
  Widget myHomeView() {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          search(),
          searchController.text.isNotEmpty && searchedItems.isEmpty
              ? emptySearch()
              : myListView()
        ],
      ),
  ...
  late List<Articles> searchedItems;

  final searchController = TextEditingController();

  late List<Articles> sportsNews;
