...
class EachItem extends StatelessWidget {
    EachItem({ Key? key,required this.articles }) : super(key: key);
final Articles articles;
var errorImage='https://cdn.dribbble.com/users/251873/screenshots/9288094/13539-sign-for-error-or-explanation-alert.gif';
  @override
  Widget build(BuildContext context) {
    return  InkWell(onTap: (){Navigator.pushNamed(context, generalScreen,arguments: articles);},
